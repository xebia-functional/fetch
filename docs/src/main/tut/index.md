...
def fetchString[F[_] : ConcurrentEffect](n: Int): Fetch[F, String] =
  Fetch(n, ToString, ToString.source)
```
...
```tut:silent
object UnbatchedToString extends Data {
...
def unbatchedString[F[_] : ConcurrentEffect](n: Int): Fetch[F, String] =
  Fetch(n, UnbatchedToString, UnbatchedToString.source)
```
